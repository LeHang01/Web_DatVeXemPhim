	...
	<div class="row">
		...
		<div class="col-sm-3 col-md-3 col-xs-6">
			<div class="moviedangchieu">
				<img src="public/anhda4/phim/{{$pdc->image}}" width="100%" height="350px">
	...
	<div class="row">
		<div class="col-md-6 col-xs-12">
			...
			<div class="blog row mt-3 mb-4">
				<div class="col-md-4">
					<a href="review/{{$r->id}}" ><img src="public/anhda4/tintuc/{{$r->image}}" width="170px"></a>
				</div>
		...
		<div class="col-md-6 col-xs-12">
			...
			<div class="blog row mt-3 mb-4">
				<div class="col-md-4">
					<a href="blog/{{$b->id}}"><img src="public/anhda4/tintuc/{{$b->image}}" width="170px"></a>
				</div>
